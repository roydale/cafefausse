...
const SidebarProvider = React.forwardRef(
  ({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, children, style, ...props }, ref) => {
    ...
    // merge CSS vars with incoming style prop
    const cssVars = {
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "group-data-[collapsible=icon]-[calc(var(--sidebar-width)_+_theme(spacing.4))]"
...
const SidebarInput = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <Input
      ref={ref}
      data-sidebar="input"
      className={cn("h-8 w-full bg-background shadow-none focus-visible-2 focus-visible-sidebar-ring", className)}
      {...props}
    />
  );
});
...
const SidebarMenuButton = React.forwardRef(
  (
    ...
    // if tooltip is a string, wrap into children prop
